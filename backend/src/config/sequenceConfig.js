...
export const sequenceConfig = {
  ...
  item: { field: "itemCode", prefix: "ITM", prefixField: "itemType" },
  crterm: { field: "termCode", prefix: "TRM" },
  assetCategory: { field: "catCode", prefix: "ACT" },
  ...
  vendorInvite: { field: "inviteNo", prefix: "VIT" },
  user: { field: "userCode", prefix: "USR" },
  chartOfAccounts: { field: "accountCode", prefix: "COA" },
  lineOfBusiness: { field: "lobCode", prefix: "L" },
};
